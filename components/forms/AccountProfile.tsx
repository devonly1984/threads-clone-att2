    ...
    <Form {...form}>
      ...
      <FormField
        ...
        render={({field }) => (
          <FormItem className="flex items-center gap-4">
            ...
            <FormControl className="flex-1 text-base-semibold text-gray-200">
              <Input placeholder="Upload a photo" accept="image/*" type="file"  
              className="account-form_image-input"
              onChange={(e)=>handleImage(e,field.onChange)}
              />
            </FormControl>
            <FormDescription>
              This is for your profile photo
            </FormDescription>
            <FormMessage />
            </FormItem>
          )}
        ...
        <FormItem className="flex gap-3 flex-col w-full">
          <FormLabel className="text-base-semibold text-gray-200 ">Name
           </FormLabel>
          <FormControl >
            <Input 
      ...
      />
        ...
        render={({field}) => (
        <FormItem className="flex gap-3 flex-col w-full">
          <FormLabel className="text-base-semibold text-gray-200 ">Bio
           </FormLabel>
          <FormControl >
            <Textarea  rows={10}
